...
if (isset($_SESSION["user"]) && isset($_POST["buy"])) {
  $date = date("Y-m-d");
  $sql = "INSERT INTO `pet_adoption`(`fk_user`, `fk_animals`, `buy_date`) VALUES ($_SESSION[user], $_POST[prod], '$date')";
}
...
if (mysqli_num_rows($res) > 0) {
    while ($row = mysqli_fetch_assoc($res)) {
            ...
            <div class='p-2'>
                <div class='card'>
                    ...
                    <div class='card-body'>
                        ...
                        <p class='card-text'>" . htmlspecialchars($row['status'] ? 'Available' : 'Adopted') . "</p>
        ...
        if (isset($_SESSION["user"]) && $row["status"] !=0 ) {
          ...
          <a href='adopt.php?petID=" . htmlspecialchars($row['id']) . "' id='btn' class='btn btn-outline-success' style='margin-bottom: 5px'>Take me Home - Test </a>
        ";
        }
...
<body>
  ...
  <div class="row py-lg-5">
    <div class="col-lg-6 col-md-8 mx-auto">
      ...
      <p class="lead text" style="color: white;"> At Loving Paws, we believe in the transformative power of companionship. Our mission is to unite extraordinary animals with compassionate individuals, creating forever homes filled with love, joy, and endless tail wags.
        Explore Our Adoption Gallery, where each furry friend has a unique story waiting to unfold. From playful pups to wise seniors, our diverse selection of different pets reflects the vibrant personalities of the animal kingdom. </p>
    </div>
  </div>
</section>
